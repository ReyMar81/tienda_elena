                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted">Modifica los datos del pedido seleccionado</p>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm border-0 mb-4">
                            <div class="card-body p-4">
                                    ...
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                            <tr v-for="producto in productosFiltrados" :key="producto.id">
                                                ...
                                                <td>
                                                    <span :class="producto.stock_actual < 10 ? 'badge bg-warning' : 'badge bg-success'">
                                ...
                                <div v-else class="alert alert-info">
                                    ...
                                    No hay productos seleccionados. Agregue al menos uno.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm border-0 mb-4">
                            <div class="card-body p-4">
                                ...
                                <div v-if="form.tipo_pago === 'credito'" class="alert alert-warning mt-3">
                                    ...
                                    <strong>Pago a Crédito:</strong> El número de cuotas se configurará al confirmar el pedido.
                                </div>
...
onMounted(() => {
    ...
    props.pedido.detalles.forEach((detalle) => {
        ...
        const descuentoPorcentaje =
            detalle.descuento > 0 ? (detalle.descuento / detalle.precio_unitario) * 100 : 0;
